import { useContext, useState, useRef, type FormEventHandler } from 'react';
...
export function NewPartnerFormComponent() {
  const { partners, addPartner } = useContext(PartnersContext)!;
  ...
  const onSubmit: FormEventHandler = async (e) => {
    ...
    await addPartner({
      ...
      locations:
        locationsInputRef.current?.files && locationsInputRef.current.files[0]
    });
